...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    ...
	    production: 'https://tranquil-plateau-30528.herokuapp.com/'
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var mealsApi = __webpack_require__(10);
	var getFormFields = __webpack_require__(11);
	var authUi = __webpack_require__(12);
	var mealsUi = __webpack_require__(13);
	var store = __webpack_require__(9);

	var onSignUp = function onSignUp(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  authApi.signUp(data).done([authUi.signUpSuccess, function (response) {
	    authApi.signIn(data).done([authUi.signInSuccess, function (response) {
	      mealsApi.getMeals().done(mealsUi.getMealsSuccess).catch(mealsUi.getMealsError);
	...
	var onSignOut = function onSignOut(event) {
	  event.preventDefault();
	  if (store.user) {
	    authApi.signOut().done(authUi.signOutSuccess).catch(authUi.signOutError);
	  } else {}
	};
	...
	var onChangePassword = function onChangePassword(event) {
	  ...
	  if (store.user) {
	    var data = getFormFields(event.target);
	    authApi.changePassword(data).done(authUi.changePasswordSuccess).catch(authUi.changePasswordError);
	  } else {}
	};
	...
	var onAddMeal = function onAddMeal(event) {
	  ...
	  if (store.user) {
	    var data = getFormFields(event.target);
	    mealsApi.addMeal(data).done(mealsUi.addMealSuccess).catch(mealsUi.addMealError);
	  }
	};
	...
	var onRenameMeal = function onRenameMeal(event) {
	  event.preventDefault();
	  if (store.user && store.meal) {
	    var data = getFormFields(event.target);
	    mealsApi.updateMeal(data).done(mealsUi.renameMealSuccess).catch(mealsUi.renameMealError);
	  }
	};

	var onGetMealItems = function onGetMealItems(event) {
	  event.preventDefault();
	  if (store.user && store.meal) {
	    mealsApi.updateMeal().done(mealsUi.getMealItemsSuccess).catch(mealsUi.getMealItemsError);
	  }
	};

	var onGetMenuItems = function onGetMenuItems(event) {
	  // event.preventDefault()
	  mealsApi.getMenuItems().done(mealsUi.getMenuItemsSuccess).catch(mealsUi.getMenuItemsError);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getMealItems = function getMealItems(mealId) {
	  return $.ajax({
	...
	var addMealItem = function addMealItem(menuItemId) {
	  return $.ajax({
	...
	var deleteMealItem = function deleteMealItem(menuItemId) {
	  return $.ajax({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var signUpFormClear = function signUpFormClear() {
	...
	var changePasswordFormClear = function changePasswordFormClear() {
	  clearForms();
	...
	module.exports = {
	  ...
	  signUpFormClear: signUpFormClear,
	  signInSuccess: signInSuccess,
	  signInError: signInError,
	  signOutSuccess: signOutSuccess,
	  signOutError: signOutError,
	  changePasswordFormClear: changePasswordFormClear,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var bellSound = document.getElementById('-bell-snd');
	bellSound.load();
	var yoquieroSound = document.getElementById('-yoquiero-snd');
	yoquieroSound.load();

	var funModeCheckBox = $('#-options-modal-funmode');

	var choose = function choose(choices) {
	  var index = Math.floor(Math.random() * choices.length);
	  return choices[index];
	};

	var animateChihuahua = function animateChihuahua() {
	  var choice = choose(['chihuahua-right', 'chihuahua', 'chihuahua-bottom']);
	...
	var mealListElement = $('#-meal-list');
	var mealListTemplate = __webpack_require__(14);
	var mealTitleElement = $('#-meal-title').find('h1');

	var selectMeal = function selectMeal(event) {
	  ...
	  mealsApi.getMealItems(mealId).done(function (response) {
	...
	var removeMeal = function removeMeal(event) {
	  // console.log('removeMeal')
	  // console.log('ID: ', event.target.dataset.id)
	  store.deleting = event.target.dataset.id;
	  mealsApi.deleteMeal(event.target.dataset.id).done(deleteMealSuccess).catch(deleteMealError);
	};

	var clearMealList = function clearMealList() {
	  mealListElement.html('');
	};

	var populateMealList = function populateMealList(meals) {
	  clearMealList();
	  // console.log('Populating meals list')
	  // console.log(meals)
	  var mealListHTML = mealListTemplate({ meals: meals });
	  mealListElement.append(mealListHTML);
	  $('.meal-button').on('click', selectMeal);
	  $('.meal-button-delete').on('click', removeMeal);
	};

	var addMealToList = function addMealToList(meal) {
	  var mealHTML = mealListTemplate({ meals: [meal] });
	...
	var clearAddMealForm = function clearAddMealForm() {
	  $('#-addmeal-modal-form input').val('');
	  $('#-addmeal-error').addClass('hidden');
	};

	var addMealSuccess = function addMealSuccess(response) {
	...
	var addMealError = function addMealError(response) {
	  // console.log('addMealError')
	  // console.log(response)
	  $('#-addmeal-error').removeClass('hidden');
	};

	var getMealsSuccess = function getMealsSuccess(response) {
	  // console.log('getMealsSuccess')
	  // console.log(response)
	  populateMealList(response.meals); // Add meals to list in the DOM
	};

	var getMealsError = function getMealsError(response) {
	  // console.log('getMealsError')
	  // console.log(response)
	};

	var deleteMealSuccess = function deleteMealSuccess(response) {
	...
	var deleteMealError = function deleteMealError(response) {
	  // console.log('deleteMealError')
	  // console.log(response)
	};

	var clearRenameMealForm = function clearRenameMealForm() {
	  $('#-renamemeal-modal-form input').val('');
	  $('#-renamemeal-error').addClass('hidden');
	};

	var renameMealSuccess = function renameMealSuccess(response) {
	...
	var renameMealError = function renameMealError(response) {
	...
	var mealItemsElement = $('#-meal-items-list');
	var mealItemsTemplate = __webpack_require__(34);

	var clearMealItems = function clearMealItems() {
	  mealItemsElement.html('');
	};

	var mealItemsPriceElement = $('#-meal-items-price');

	var updateMealPrice = function updateMealPrice() {
	...
	var populateMealItems = function populateMealItems(items) {
	  clearMealItems();
	  var mealItemsHTML = mealItemsTemplate({ items: items }); // Use template to get HTML element(s)
	  mealItemsElement.append(mealItemsHTML);
	  $('.meal-item-button-delete').on('click', onDeleteMealItem);
	  updateMealPrice();
	};

	var getMealItemsSuccess = function getMealItemsSuccess(response) {
	...
	var getMealItemsError = function getMealItemsError(response) {
	  // console.log('getMealItemsError')
	  // console.log(response)
	};

	var onAddMealItem = function onAddMealItem(event) {
	  event.preventDefault();
	  // console.log('onAddMealItem: ', event)
	  if (store.user && store.meal) {
	    var menuId = event.target.dataset.id;
	    // console.log('Menu ID: ', menuId)
	    mealsApi.addMealItem(menuId).done(addMealItemSuccess).catch(addMealItemError);
	  }
	};

	var addMealItemSuccess = function addMealItemSuccess(response) {
	  // console.log('addMealItemSuccess')
	  // console.log(response)
	  // console.log(response.menu_item)
	  var mealItemsHTML = mealItemsTemplate({ items: [response.menu_item] });
	  mealItemsElement.append(mealItemsHTML);
	...
	var addMealItemError = function addMealItemError(response) {
	  // console.log('addMealItemError')
	  // console.log(response)
	};

	var onDeleteMealItem = function onDeleteMealItem(event) {
	  event.preventDefault();
	  // console.log('onDeleteMealItem: ', event)
	  if (store.user && store.meal) {
	    var menuId = event.target.dataset.id;
	    // console.log('Menu ID: ', menuId)
	    mealsApi.deleteMealItem(menuId).done(function (response) {
	...
	var deleteMealItemSuccess = function deleteMealItemSuccess(response) {
	  // console.log('deleteMealItemSuccess')
	  // console.log(response)
	  updateMealPrice();
	};

	var deleteMealItemError = function deleteMealItemError(response) {}
	...
	;var menuItemsElement = $('#-menu-items-list');
	var menuItemsTemplate = __webpack_require__(35);
	var menuInstructionsElement = $('#-menu-instruct');

	var populateMenuItems = function populateMenuItems(items) {
	  menuItemsElement.html('');
	  var menuItemsHTML = menuItemsTemplate({ items: items }); // Use template to get HTML element(s)
	  menuItemsElement.append(menuItemsHTML);
	  // Attach add item event to menu items button
	  $('.menu-button-add').on('click', onAddMealItem);
	};

	var getMenuItemsSuccess = function getMenuItemsSuccess(response) {
	  // console.log('getMenuItemsSuccess')
	  // console.log(response)
	  populateMenuItems(response.menu_items);
	};

	var getMenuItemsError = function getMenuItemsError(response) {
	...
	module.exports = {
	  ...
	  addMealError: addMealError,
	  getMealsSuccess: getMealsSuccess,
	  getMealsError: getMealsError,
	  deleteMealSuccess: deleteMealSuccess,
	  deleteMealError: deleteMealError,
	  renameMealSuccess: renameMealSuccess,
	  renameMealError: renameMealError,
	  getMealItemsSuccess: getMealItemsSuccess,
	  getMealItemsError: getMealItemsError,
	  getMenuItemsSuccess: getMenuItemsSuccess,
	  getMenuItemsError: getMenuItemsError,
	  clearAddMealForm: clearAddMealForm,
	  clearRenameMealForm: clearRenameMealForm
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "  <div class=\"meal-div\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n    <button type=\"button\" class=\"btn btn-lg btn-yellow meal-button\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n      "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + "\n    </button>\n    <button type=\"button\" class=\"btn btn-lg btn-danger meal-button-delete float-right\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "  <div class=\"meal-item\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" data-cost=\""
	    ...
	    + " - $"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.cost : stack1), depth0))
	    + "</div>\n    <button type=\"button\" class=\"btn btn-lg btn-danger meal-item-button-delete\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\"><i class=\"fa fa-trash\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "  <div class=\"menu-item\" data-id=\""
	    ...
	    + "\" data-price=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.cost : stack1), depth0))
	    + "\">\n    <button type=\"button\" class=\"btn btn-success menu-button-add\"  data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\"><i class=\"fa fa-plus-square\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" aria-hidden=\"true\"></i></button>\n    <span class=\"menu-item-span\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + " - $"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "02181753b82d04e094a1c48fdcf84805.ttf";
